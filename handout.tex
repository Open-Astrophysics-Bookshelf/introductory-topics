...
\newcommand*{\notice}{\thanks{Excerpt from \maintitle, git version \input{git-info}\ldots. \ccCopy\ 2015, 2016 Edward Brown; \ccbyncsa\ Except where explicitly noted, this work is licensed under the Creative Commons
