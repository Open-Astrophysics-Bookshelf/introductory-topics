...
\begin{exercisebox}[Reading license plates from orbit]
It is often claimed that some agencies have the technological capability to read license plates from satellites. Evaluate this claim: for a telescope in low-Earth orbit, how large an aperture would be required to resolve the lettering on a license plate? Could Hubble (\val{2.4}{\meter} aperture) do this? Use your best guess the orbital altitude and letter size, but justify your reasoning.
\end{exercisebox}
