...
For systems with sufficiently large inclination, we will observe the planet to \newterm{transit} the star, that is, to pass in front of the stellar disk. From Fig.~\ref{f.transit}, if
\begin{marginfigure}
