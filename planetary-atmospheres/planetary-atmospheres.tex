...
%\marginnote[-4\baselineskip]{Recall that $\val{1}{\unitstyle{bar}} = \val{\sci{1.013}{5}}{\unitstyle{Pa}}$.  The density of air at sea level is $\val{1.3}{\kilo\gram\usk\meter^{-3}}$.}
...
\begin{exercisebox}[Deflection of updrafts in a thunderstorm]
