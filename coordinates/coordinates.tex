...
Finally, we notice that to lowest order, $\cos\delta_{1}\cos\delta_{2}\approx \cos^{2}\delta$, where $\delta = (\delta_{1}+\delta_{2})/2$ is the average of the two declinations. Upon making this substitution, we recover equation~(\ref{e.angular-separation}).
\end{sidebar}
